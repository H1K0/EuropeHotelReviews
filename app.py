...
from pages import index, overview, hotel, countries
    ...
    [
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink("Все отели", href="/overview", active="exact"),
                dbc.NavLink("Сводка об отеле", href="/hotel", active="exact"),
                dbc.NavLink("Карта", href="/countries", active="exact"),
            ],
            vertical=True,
            pills=True,
        ),
...
def render_page_content(pathname):
    ...
    return html.Div(
        [
            ...
            html.Hr(),
            html.P(f"Несуществующий путь: {pathname}"),
        ],
